  ...
  RSpec.describe Order, type: :model do
    ...
    describe '#compare_consumer_dept' do
      context 'when consumer_dept does not match with division of the selected item' do
        ...
        let(:item_to_orders) { [{ invent_item_id: workplace_714.items.last.item_id }] }
        let(:operations) { [attributes_for(:order_operation, invent_item_id: 714)] }
        subject { build(:order, item_to_orders_attributes: item_to_orders, operations_attributes: operations, consumer_dept: 715) }
