...
module Warehouse
  RSpec.describe Order, type: :model do
    ...
    describe '#uniqueness_of_workplace' do
      let!(:workplace_1) { create(:workplace_pk, :add_items, items: [:pc, :monitor], dept: 714) }
    ...
    describe '#set_workplace' do
      let!(:workplace) { create(:workplace_pk, :add_items, items: [:pc, :monitor], dept: 714) }
      let(:item_to_orders) do
        [
    ...
    describe '#compare_consumer_dept' do
      context 'when consumer_dept does not match with division of the selected item' do
        let!(:workplace_714) { create(:workplace_pk, :add_items, items: [:pc, :monitor], dept: 714) }
        let!(:workplace_715) { create(:workplace_pk, :add_items, items: [:pc, :monitor], dept: 715) }
