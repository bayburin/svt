  ...
  RSpec.describe WorkplaceCountsController, type: :controller do
    ...
    describe 'POST #create ' do
      ...
      context 'when creates workplace_count with new user' do
        ...
        it 'creates user with role :lk_user' do
          post :create, params: params

          expect(user_attr.role_id).to eq Role.find_by(name: 'lk_user').id
        end
      end
    ...
    describe 'DELETE #destroy' do
      let(:user1) { create(:bayburin_user) }
      let(:user2) { create(:kucherenko_user) }
