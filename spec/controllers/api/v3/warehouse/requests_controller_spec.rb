    ...
    module Warehouse
      RSpec.describe RequestsController, type: :controller do
        describe 'POST #new_office_equipment' do
          ...
          let(:emp_user) { build(:emp_kucherenko) }
            ...
            let(:params) do
              {
                ...
                parameters: '{
                  "common": {
                    "tn": 24079,
                    "fio": "Кучеренко Виктор Николаевич",
                    "lk_id": 1000
                  },
                  "table_data": [
                    {
          ...
          context 'when param :number_lk is blank' do
            let(:params) do
              {
                id: 121,
                description: 'Выдача вычислительной техники в подразделение согласно перечня ПО',
        ...
        describe 'GET #request_files' do
          ...
          let(:url) { "https://#{ENV['APP_HOSTNAME']}.iss-reshetnev.ru/api/v3/warehouse/requests/download_adddiitional_files/#{attachment_request.id}" }
