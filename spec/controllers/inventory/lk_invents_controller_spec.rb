...
module Inventory
  RSpec.describe LkInventsController, type: :controller do
    ...
    before do
      # allow(LkInvents::LkAuthorization).to receive(:data).and_return(@lk_user)
      # allow(controller).to receive(:check_lk_authorization).and_return(true)
      # allow(controller).to receive(:sign_out).with(@lk_user)
    end
    ...
    describe 'GET #show_division_data' do
      it 'creates instance of the LkInvents::ShowDivisionData class' do
        get :show_division_data, params: { id_tn: @lk_user.id_tn, division: workplace_count.division }
    ...
    describe 'GET #pc_config_from_audit' do
      ...
      it 'creates instance of the LkInvents::PcConfigFromAudit class' do
        get :pc_config_from_audit, params: { id_tn: @lk_user.id_tn, invent_num: item.invent_num }
    ...
    describe 'POST #create_workplace' do
      ...
      before { post :create_workplace, params: { id_tn: @lk_user.id_tn, workplace: workplace.to_json, pc_file: file } }
    ...
    describe 'GET #edit_workplace' do
      ...
      before { get :edit_workplace, params: { id_tn: @lk_user.id_tn, workplace_id: workplace.workplace_id } }
    ...
    describe 'DELETE #delete_workplace' do
      ...
      it 'create instance of the LkInvents::DeleteWorkplace' do
        delete :delete_workplace, params: { id_tn: @lk_user.id_tn, workplace_id: workplace.workplace_id }
