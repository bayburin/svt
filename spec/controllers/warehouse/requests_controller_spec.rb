...
module Warehouse
  RSpec.describe RequestsController, type: :controller do
    ...
    describe 'GET #index' do
      ...
      %w[user_tn user_id_tn user_fio user_dept user_phone number_orbita number_lk executor_fio executor_tn comment status_translated category_translate request_items].each do |i|
    ...
    describe 'PUT #send_to_owner' do
      ...
      let(:owner) { attributes_for(:kucherenko_user) }
