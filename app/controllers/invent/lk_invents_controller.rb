module Invent
  class LkInventsController < ApplicationController
    ...
    before_action :check_lk_authorization, except: %i[svt_access existing_item invent_item]
    ...
    def svt_access
      ...
      if @svt_access.run
        ...
        render json: { full_message: I18n.t('controllers.lk_invents.unprocessable_entity') }, status: 422
      end
    end
    ...
    def pc_config_from_user
      ...
      if @pc_file.run
        render json: { data: @pc_file.data, full_message: I18n.t('controllers.lk_invents.file_added') }
      else
