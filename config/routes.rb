Rails.application.routes.draw do
  ...
  namespace :inventory do
    ...
    # Запросы с ЛК
    # Инициализация
    get 'lk_invents/init_properties/:id_tn', to: 'lk_invents#init_properties', constraints: { id_tn: /\d+/ }
    ...
    patch 'lk_invents/update_workplace/:workplace_id',
          ...
          constraints: { workplace_id: /\d+/ }
    # Удалить РМ
    delete 'lk_invents/delete_workplace/:workplace_id',
           to: 'lk_invents#delete_workplace',
           constraints: { workplace_id: /\d+/ }
